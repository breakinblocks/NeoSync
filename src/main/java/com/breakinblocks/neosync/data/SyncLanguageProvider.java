...
public final class SyncLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("command.neosync.anchor.ensure.skipped", "%s already has a shell to sync into, no anchor was set");
        ...
        add("command.neosync.anchor.list.entry.temporary", "%s has a one-time respawn anchor at %s in %s");
